...
/// <summary>
/// Holds the <see cref="DiskOnlyImageLoader"/> instances used across the app, one per display size.
/// </summary>
/// <remarks>
...
public static class ImageLoaders
{
	...
	public static readonly DiskOnlyImageLoader Default = new(160 * 2);

	// Achievement icons are displayed at 60px wide; cache at 2x that for HiDPI screens.
	public static readonly DiskOnlyImageLoader Icon = new(60 * 2);
